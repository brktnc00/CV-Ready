...
// Oturuma duyarlı global üst-bar — açık "Luminous Nexus" dilinde.
export default async function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-ink/5 bg-white/70 backdrop-blur-md">
...
function SignOutButton() {
  return (
    <form action={signOut}>
      <button className="glass glass-hover flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-sm font-semibold text-ink/70 hover:text-ink">
