...
export default function CandidateCard({ c, demo = false }: { c: CandidateCardData; demo?: boolean }) {
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col overflow-hidden rounded-3xl border border-ink/8 bg-white shadow-card transition-all hover:-translate-y-1 hover:border-violet/30 hover:shadow-card-lg"
    >
